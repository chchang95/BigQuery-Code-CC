...
from dw_prod_extracts.ext_today_knowledge_policy_monthly_premiums epud
    ...
    left join (select policy_id, calculated_fields_non_cat_risk_class, calculated_fields_cat_risk_class from dw_prod_extracts.ext_policy_snapshots where date_snapshot = '2020-10-25') eps on eps.policy_id = epud.policy_id
        where date_knowledge = '2020-10-25'
