...
from full_data
where (incurred_total_net_recoveries is not null or earned_prem_x_ebsl_x_policy_fees + earned_exposure is not null)
and calendar_quarter is not null
order by carrier, calendar_quarter, carrier_segment desc
)
, with_percents as (
select 
*
...
,earned_prem_x_ebsl_x_policy_fees_percent * 0.1  + earned_exposure_percent * 0.2  + Reported_Loss_NonCat_xFire_percent * 0.3  + Case_Reserves_NonCat_xFire_percent * 0.1  + Paid_Losses_NonCat_xFire_percent * 0.1  + Open_Counts_NonCat_xFire_percent * 0.1  + Reported_Counts_NonCat_xFire_percent * 0.1 as NonCat_xFire_Selected_Allocation
,earned_prem_x_ebsl_x_policy_fees_percent * 0.1  + earned_exposure_percent * 0.2  + Reported_Loss_NonCat_Fire_percent * 0.3  + Case_Reserves_NonCat_Fire_percent * 0.1  + Paid_Losses_NonCat_Fire_percent * 0.1  + Open_Counts_NonCat_Fire_percent * 0.1  + Reported_Counts_NonCat_Fire_percent * 0.1 as NonCat_Fire_Selected_Allocation
,earned_prem_x_ebsl_x_policy_fees_percent * 0.1  + earned_exposure_percent * 0.2  + Reported_Loss_Excess_percent * 0.3  + Case_Reserves_Excess_percent * 0.1  + Paid_Losses_Excess_percent * 0.1  + Open_Counts_Excess_percent * 0.1  + Reported_Counts_Excess_percent * 0.1 as Excess_Selected_Allocation
,earned_prem_x_ebsl_x_policy_fees_percent * 0.1  + earned_exposure_percent * 0.2  + Reported_Loss_NonCat_ALAE_percent * 0.3  + Case_Reserves_NonCat_ALAE_percent * 0.1  + Paid_Losses_NonCat_ALAE_percent * 0.1  + Open_Counts_NonCat_ALAE_percent * 0.1  + Reported_Counts_NonCat_ALAE_percent * 0.1 as NonCat_ALAE_Selected_Allocation
,earned_prem_x_ebsl_x_policy_fees_percent * 0.1  + earned_exposure_percent * 0.2  + Reported_Loss_CATxWS_percent * 0.3  + Case_Reserves_CATxWS_percent * 0.1  + Paid_Losses_CATxWS_percent * 0.1  + Open_Counts_CATxWS_percent * 0.1  + Reported_Counts_CATxWS_percent * 0.1 as CATxWS_Selected_Allocation
,earned_prem_x_ebsl_x_policy_fees_percent * 0.1  + earned_exposure_percent * 0.2  + Reported_Loss_CATxWS_ALAE_percent * 0.3  + Case_Reserves_CATxWS_ALAE_percent * 0.1  + Paid_Losses_CATxWS_ALAE_percent * 0.1  + Open_Counts_CATxWS_ALAE_percent * 0.1  + Reported_Counts_CATxWS_ALAE_percent * 0.1 as CatxWS_ALAE_Selected_Allocation
,earned_prem_x_ebsl_x_policy_fees_percent * 0  + earned_exposure_percent * 0  + Reported_Loss_CAT_WS_percent * 0.5  + Case_Reserves_CAT_WS_percent * 0.1  + Paid_Losses_CAT_WS_percent * 0.05  + Open_Counts_CAT_WS_percent * 0.3  + Reported_Counts_CAT_WS_percent * 0.05 as CAT_WS_Selected_Allocation
,earned_prem_x_ebsl_x_policy_fees_percent * 0  + earned_exposure_percent * 0  + Reported_Loss_CAT_WS_ALAE_percent * 0.5  + Case_Reserves_CAT_WS_ALAE_percent * 0.1  + Paid_Losses_CAT_WS_ALAE_percent * 0.05  + Open_Counts_CAT_WS_ALAE_percent * 0.3  + Reported_Counts_CAT_WS_ALAE_percent * 0.05 as CAT_WS_ALAE_Selected_Allocation
,earned_prem_x_ebsl_x_policy_fees_percent * 0  + earned_exposure_percent * 0.2  + Reported_Loss_EBSL_percent * 0.5  + Case_Reserves_EBSL_percent * 0.05  + Paid_Losses_EBSL_percent * 0.05  + Open_Counts_EBSL_percent * 0.1  + Reported_Counts_EBSL_percent * 0.1 as EBSL_Selected_Allocation
,earned_prem_x_ebsl_x_policy_fees_percent * 0  + earned_exposure_percent * 0.2  + Reported_Loss_EBSL_ALAE_percent * 0.5  + Case_Reserves_EBSL_ALAE_percent * 0.05  + Paid_Losses_EBSL_ALAE_percent * 0.05  + Open_Counts_EBSL_ALAE_percent * 0.1  + Reported_Counts_EBSL_ALAE_percent * 0.1 as EBSL_ALAE_Selected_Allocation
,earned_prem_x_ebsl_x_policy_fees_percent * 0.4  + earned_exposure_percent * 0.4  + Reported_Loss_NonCat_xFire_percent * 0.2  + Case_Reserves_NonCat_xFire_percent * 0  + Paid_Losses_NonCat_xFire_percent * 0  + Open_Counts_NonCat_xFire_percent * 0  + Reported_Counts_NonCat_xFire_percent * 0 as NonCat_Claim_Count_Selected_Allocation
,earned_prem_x_ebsl_x_policy_fees_percent * 0.4  + earned_exposure_percent * 0.4  + Reported_Loss_CATxWS_percent * 0.2  + Case_Reserves_CATxWS_percent * 0  + Paid_Losses_CATxWS_percent * 0  + Open_Counts_CATxWS_percent * 0  + Reported_Counts_CATxWS_percent * 0 as Cat_Claim_Count_Selected_Allocation
,earned_prem_x_ebsl_x_policy_fees_percent * 0.4  + earned_exposure_percent * 0.4  + Reported_Loss_EBSL_percent * 0.2  + Case_Reserves_EBSL_percent * 0  + Paid_Losses_EBSL_percent * 0  + Open_Counts_EBSL_percent * 0  + Reported_Counts_EBSL_percent * 0 as EBSL_Claim_Count_Selected_Allocation
