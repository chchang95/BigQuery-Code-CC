...
case when renewal_offered_flag = 0 or initial_written_premium_w_pol_fees = 0 then null else round(initial_at_offer_premium_w_pol_fees / initial_written_premium_w_pol_fees,1) end as initial_to_initial_at_offer,
case when renewal_offered_flag = 0 or initial_at_offer_premium_w_pol_fees = 0 then null else round(renewal_offer_premium_w_pol_fees / initial_at_offer_premium_w_pol_fees,1) end as initial_at_offer_to_renewal_offer,
case when renewal_accepted_flag = 0 or renewal_offer_premium_w_pol_fees = 0 then null else round(renewal_effective_premium_w_pol_fees / renewal_offer_premium_w_pol_fees,1) end as renewal_offer_to_renewal_effective,
case when renewal_accepted_flag = 0 or initial_written_premium_w_pol_fees = 0 then null else round(renewal_effective_premium_w_pol_fees / initial_written_premium_w_pol_fees,1) end as initial_to_renewal_effective,
