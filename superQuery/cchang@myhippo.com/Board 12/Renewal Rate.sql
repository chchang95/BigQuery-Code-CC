...
with top as(SELECT 
    ...
    coalesce(rensnap2.quote_premium_base,0) + coalesce(rensnap2.quote_premium_optionals,0) + coalesce(rensnap2.quote_policy_fee,0) as renewal_accepted_premium_w_pol_fees,
    rensnap2.coverage_a as renewal_accepted_coverage_a,
...
sum(initial_at_offer_premium_w_pol_fees) as initial_at_offer_quote_premium_w_pol_fees,
...
sum(renewal_accepted_premium_w_pol_fees) as renewal_effective_premium_w_pol_fees,
sum(renewal_accepted_coverage_a) as renewal_effective_coverage_a,
