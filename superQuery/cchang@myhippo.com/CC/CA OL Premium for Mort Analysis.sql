...
from dbt_actuaries.ext_today_knowledge_policy_monthly_premiums_20210131 epud
    left join (select policy_id, on_level_factor, property_data_address_zip from dw_staging_extracts.ext_policy_snapshots where date_snapshot = '2021-01-31') seps on seps.policy_id = epud.policy_id
