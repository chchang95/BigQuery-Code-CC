...
,state 
,product 
,property_data_protection_class as fire_protection_class
,property_data_year_built as construction_year
,property_data_number_of_family_units as number_of_family_units
,coverage_water_backup as water_backup_coverage
,coverage_extended_rebuilding_cost as extended_rebuilding_cost
