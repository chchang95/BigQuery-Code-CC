...
select policy_id, policy_number, claim_number, treaty, loss_date, report_date, Inception_Date, Expiration_Date, first_term_eff, last_term_eff, max_term, claim_status, Total_Incurred
from x
