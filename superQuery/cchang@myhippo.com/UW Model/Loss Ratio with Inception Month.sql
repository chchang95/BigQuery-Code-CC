...
from dw_prod_extracts.ext_policy_snapshots where date_snapshot = '2020-06-28'
)
, premium as (
select state
,carrier
...
left join snapshot eps 
  ...
  WHERE date_knowledge = '2020-06-28'
  and carrier <> 'Canopius'
)
, claims as (
select
...
select distinct date_knowledge
from dw_prod_extracts.ext_today_knowledge_policy_monthly_premiums