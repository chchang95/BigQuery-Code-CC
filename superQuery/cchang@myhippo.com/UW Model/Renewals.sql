...
, date_policy_expires 
, renewal_number
, date_trunc(date_policy_effective, MONTH) as inception_month
, case when state = 'tx' and calculated_fields_cat_risk_score = 'referral' then 'referral' 
        ...
        else calculated_fields_non_cat_risk_class end as quoted_uw_action 
, calculated_fields_non_cat_risk_score as quoted_risk_score
,coverage_a
,property_data_address_zip as zip
,property_data_address_county as county
, property_data_has_smart_home
, property_data_smart_home_kit_activated
, property_data_smart_home_water_leak_device
, calculated_fields_five_years_claims
, calculated_fields_three_years_claims
, number_of_loss_history_claims
...
,quote_rater_version as rater_version
,insurance_score
...
,written_base + written_total_optionals - written_optionals_equipment_breakdown - written_optionals_service_line as written_prem_x_ebsl
...
,earned_policy_fee
,written_policy_fee
,written_exposure as written_exposure
,earned_exposure as earned_exposure
from dw_prod_extracts.ext_policy_snapshots
where 1=1
and date_snapshot = '2020-07-31'
and carrier <> 'Canopius'
...
select r.*, sf.risk_score as calculated_non_cat_risk_score
...
from renewals r
left join claims c on r.policy_id = c.policy_id 
left join scoring_final sf on r.policy_id = sf.policy_id