...
--       , is_ebsl
  ...
  left join dbt_actuaries.claim_cat_coding_20210314 cc on (case when tbl_source = 'topa_tpa_claims' then ltrim(mon.claim_number,'0') else mon.claim_number end) = cast(cc.claim_number as string)
  WHERE 1=1
