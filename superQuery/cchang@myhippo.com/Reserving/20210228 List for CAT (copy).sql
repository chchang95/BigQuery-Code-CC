...
--       , is_ebsl
    ...
    , loss_description
    , damage_description
  FROM dbt_actuaries.ext_all_claims_combined_20210308 mon
  ...
  left join dbt_actuaries.cat_coding_w_loss_20210309 cc on (case when tbl_source = 'topa_tpa_claims' then ltrim(mon.claim_number,'0') else mon.claim_number end) = cast(cc.claim_number as string)
  WHERE 1=1
  and date_knowledge = '2021-03-08'
