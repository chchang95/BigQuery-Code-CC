...
left join (select policy_id, renewal_number from dw_prod_extracts.ext_policy_snapshots where date_snapshot = '2020-07-30') eps on eps.policy_id = cd.policy_id
  WHERE date_knowledge = '2020-07-30'
  and carrier <> 'Canopius'
)
, claims as (
select
