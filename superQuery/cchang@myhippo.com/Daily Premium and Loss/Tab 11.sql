...
from dbt_actuaries.ext_today_knowledge_policy_monthly_premiums_20210131 epud
...
, aggregated as (
    select 
        ...
        ,carrier
        ,product
        ,last_day(date_accounting_start,month) as accident_month
        ,date_accounting_end as accident_month_end
        ,last_day(date_trunc(date_accounting_start, QUARTER),QUARTER) as accident_quarter
        ,calendar_year
        -- ,reinsurance_treaty_property_accounting
        -- ,organization_id
        -- ,channel
...
where 1=1
-- and product <> 'ho5'
and accident_month is not null
