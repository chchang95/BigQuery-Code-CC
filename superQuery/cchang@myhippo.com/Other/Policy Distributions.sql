...
select state, ROUND(avg(cast(calculated_fields_coverages_tiv as numeric)),0), avg(written_base + written_optional - written_optionals_equipment_breakdown - written_optionals_service_line) from dw_prod_extracts.ext_policy_snapshots 
