...
channel, 
cast(eps.coverage_a as numeric) - mod(cast(eps.coverage_a as numeric),10000),
cast(eps.calculated_fields_age_of_home as numeric) - mod(cast(eps.calculated_fields_age_of_home as numeric),3),
