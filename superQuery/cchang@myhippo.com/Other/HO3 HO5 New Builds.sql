...
left join (select organization_id, organization_name, root_organization_name, organization_type, organization_type_with_producer_split
from dw_prod.dim_organization_mappings) dom on dp.org_id = dom.organization_id 
