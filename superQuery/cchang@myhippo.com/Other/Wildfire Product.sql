...
--       ,q.date_bound
      ...
      FROM quotes_dedup_first_attribution ddp
            ...
            left join (select policy_id, property_data_roof_type from dw_prod_extracts.ext_policy_snapshots where date_snapshot = '2020-09-17') ps on q.policy_id = ps.policy_id
      where q.date_quote_first_seen >= '2018-01-01'
      and q.state = 'ca'
      and q.product = 'ho3'
