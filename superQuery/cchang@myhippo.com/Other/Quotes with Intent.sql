...
--       cast(q.date_quote_first_seen as DATE) as quote_date
    ...
    --   when cast(q.year_built as numeric) >= 1980 then 'Post 1980' 
...
--       when non_cat_risk_class = 'exterior_inspection_required' or non_cat_risk_class = 'interior_inspection_required' or non_cat_risk_class = 'referral' then 'rocky'
--       when non_cat_risk_class = 'no_action' then 'happy'
--       else 'not_applicable' end as UW_Path
    --   ,q.date_bound
      ...
      where q.date_quote_first_seen >= '2019-10-01'
    --   and q.state = 'CA'
      and q.product <> 'HO5'
    --   and q.carrier = 'Topa'
