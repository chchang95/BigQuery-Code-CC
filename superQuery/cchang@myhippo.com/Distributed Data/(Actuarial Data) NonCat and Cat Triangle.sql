...
-- mon.claim_number,
    ...
    ,sum(case when total_incurred_inception_to_date >= 100000 and cat_indicator is false then 100000 else total_incurred_inception_to_date end) as Incurred_Loss_Capped_At_100k_NonCat_Only_Cumulative
    ,sum(case when total_incurred_inception_to_date >= 100000 and cat_indicator is false then total_incurred_inception_to_date - 100000 else 0 end) as Incurred_Loss_Excess_of_100k_NonCat_Only_Cumulative
  FROM
    claims_supp mon
