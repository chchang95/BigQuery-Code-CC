...
,written_base + written_total_optionals + written_policy_fee as written_premium_total
-- ,written_base
-- ,written_policy_fee
-- ,written_total_optionals
-- ,written_optionals_equipment_breakdown
-- ,written_optionals_service_line
,earned_base + earned_total_optionals + earned_policy_fee as earned_premium_total
-- ,earned_policy_fee
...
and date_policy_effective <= '2020-08-31'
